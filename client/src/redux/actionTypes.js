...
export const GET_FACULTY_DASHBOARD_STATS = "GET_FACULTY_DASHBOARD_STATS"; // Action type for dashboard stats
...
export const GET_SUBJECT_FACULTY = "GET_SUBJECT_FACULTY";
