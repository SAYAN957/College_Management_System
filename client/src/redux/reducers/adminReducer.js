  ...
  switch (action.type) {
    ...
    case GET_ALL_FACULTY:
      return {
        ...
        faculties: { result: action.payload },
      };
    case GET_ALL_ADMIN:
      return {
        ...state,
    ...
    case GET_ALL_STUDENT:
      ...
      case ASSIGN_SUBJECT:
        return {
          ...state,
          subjectAssigned: action.payload,
        };
      case REMOVE_SUBJECT:
        return {
          ...state,
          subjectRemoved: action.payload,
        };
      case GET_FACULTY_SUBJECTS:
        return {
          ...state,
          facultySubjects: action.payload,
        };
      case GET_SUBJECT_FACULTY:
        return {
          ...state,
          subjectFaculty: action.payload,
        };
    default:
      return state;
  }
